...
<div class="col-md-4 col-sm-12 cart-shopping-total">
	<table class="table table-bordered">
		...
		<tbody><h4 style="color:#12cca7">Pay with Mobile Money/Bank</h4>	<button type="submit" name="ordersubmit" class="btn btn-primary">PROCCED TO CHEKOUT</button>
				<tr>
					<td>
					...
					<a  class="" href="https://flutterwave.com/pay/bix9c6eczdl6"> <img style="  HEIGHT:100PX; BORDER-RADIUS:20PX"src="img/mtn.jpg"></a>
					...
					<td>
						...
						<a  href="https://flutterwave.com/pay/bix9c6eczdl6"> <img style="  HEIGHT:100PX; BORDER-RADIUS:20PX" src="img/ma.jpg"></a> 
						</div>
