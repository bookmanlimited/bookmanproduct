...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="width:505px;background-image: url(assets/images/sliders/order-online-2-bercos.gif);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	     <div class="full-width-slider">
			<div class="item full-width-slider" style="  width:505px;background-image: url(assets/images/sliders/girl.jpg)">
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Updated Products</h3>
